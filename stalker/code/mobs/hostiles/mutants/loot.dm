...
/obj/item/reagent_containers/food/snacks/meat/slab/mutantmeat
	...
	grind_results = list("carbon" = 10, "unknownsubstance" = 5, "nutriment" = 10, "blood" = 10)
	var/cooked_type = /obj/item/reagent_containers/food/snacks/meat/steak/mutant
	var/slice_path = /obj/item/reagent_containers/food/snacks/meat/rawcutlet/mutant
	var/tastes = list("meat" = 1)
	var/foodtype = MEAT | RAW
	var/dried_type = /obj/item/reagent_containers/food/snacks/sosjerky/mutant
	var/bitesize = 3
