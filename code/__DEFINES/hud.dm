...
/proc/ui_hand_position(i) //values based on old hand ui positions (CENTER:-/+16,SOUTH:5)
	...
	return"CENTER+[x_off]:16,SOUTH+[y_off]"

/proc/ui_equip_position(mob/M)
	var/y_off = round((M.held_items.len-1) / 2) //values based on old equip ui position (CENTER: +/-16,SOUTH+1)
	return "CENTER:-16,SOUTH+[y_off+1]"

/proc/ui_swaphand_position(mob/M, which = 1) //values based on old swaphand ui positions (CENTER: +/-16,SOUTH+1)
	var/x_off = which == 1 ? -1 : 0
	var/y_off = round((M.held_items.len-1) / 2)
	return "CENTER+[x_off]:16,SOUTH+[y_off+1]"

//Lower left, persistent menu
#define ui_inventory "WEST,SOUTH+1"
#define ui_inventory_autism "WEST,SOUTH+4:2"
...
#define ui_sstore1 "CENTER-3:16,SOUTH"
#define ui_id "WEST+2:4,SOUTH"
#define ui_belt "CENTER-4:16,SOUTH"
#define ui_back "CENTER-2:16,SOUTH"
#define ui_storage1 "CENTER+1:16,SOUTH"
#define ui_storage2 "CENTER+2:16,SOUTH"
#define ui_combo "CENTER+4:24,SOUTH+1:7" //combo meter for martial arts

//Lower right, persistent menu
#define ui_drop_throw "EAST-1,SOUTH+1"
#define ui_above_movement "EAST-1,SOUTH+1"
#define ui_above_intent "EAST-2,SOUTH+1"
#define ui_above_bolt "EAST-3,SOUTH+1"
#define ui_movi "EAST-1,SOUTH"
#define ui_acti "EAST-3:24,SOUTH:5"
#define ui_combat_toggle "EAST-2,SOUTH"
...
#define ui_cutedecor "WEST,SOUTH"
...
#define ui_shoes "WEST+1:4,SOUTH+1:4"
#define ui_iclothing "WEST:4,SOUTH+2:4"
#define ui_oclothing "WEST+1:4,SOUTH+2:4"
#define ui_gloves "WEST+2:4,SOUTH+1:4"
#define ui_glasses "WEST+2:4,SOUTH+3:4"
#define ui_mask "WEST:4,SOUTH+3:4"
#define ui_ears "WEST+2:4,SOUTH+2:4"
#define ui_neck "WEST:4,SOUTH+1:4"
#define ui_head "WEST+1:4,SOUTH+3:4"

//Humans
#define ui_bolt "EAST-3,SOUTH"
